...
c_extensions = OrderedDict([
    ('modified_gensim.gensim.models.word2vec_inner', 'modified_gensim/gensim/models/word2vec_inner.c'),
    ('modified_gensim.gensim.corpora._mmreader', 'modified_gensim/gensim/corpora/_mmreader.c'),
    ('modified_gensim.gensim.models.fasttext_inner', 'modified_gensim/gensim/models/fasttext_inner.c'),
    ('modified_gensim.gensim._matutils', 'modified_gensim/gensim/_matutils.c'),
    ('modified_gensim.gensim.models.nmf_pgd', 'modified_gensim/gensim/models/nmf_pgd.c'),
    ('modified_gensim.gensim.similarities.fastss', 'modified_gensim/gensim/similarities/fastss.c'),
])

cpp_extensions = OrderedDict([
    ('modified_gensim.gensim.models.doc2vec_inner', 'modified_gensim/gensim/models/doc2vec_inner.cpp'),
    ('modified_gensim.gensim.models.word2vec_corpusfile', 'modified_gensim/gensim/models/word2vec_corpusfile.cpp'),
    ('modified_gensim.gensim.models.fasttext_corpusfile', 'modified_gensim/gensim/models/fasttext_corpusfile.cpp'),
    ('modified_gensim.gensim.models.doc2vec_corpusfile', 'modified_gensim/gensim/models/doc2vec_corpusfile.cpp'),
])
...
class CleanExt(distutils.cmd.Command):
    ...
    def run(self):
        for root, dirs, files in os.walk('modified_gensim/gensim'):
            files = [
                os.path.join(root, f)
                for f in files
