...
cdef REAL_t[EXP_TABLE_SIZE] LOG_TABLE #MODIF
...
cdef struct Word2VecConfig:
    int hs, negative, sample, compute_loss, layer1_size, size, window, cbow_mean, null_word_index, workers
    REAL_t running_training_loss, alpha
    np.uint32_t rejected_by_max_exp #MODIF
    int force_log_exp #MODIF
    # int word_wise_loss #MODIF
    # REAL_t *words_loss #MODIF
    # np.uint32_t nb_word_losses #MODIF
