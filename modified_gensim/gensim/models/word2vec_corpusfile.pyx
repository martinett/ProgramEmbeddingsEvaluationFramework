...
from modified_gensim.gensim.utils import any2utf8
...
from modified_gensim.gensim.models.word2vec_inner cimport (
...
def train_epoch_sg(model, corpus_file, offset, _cython_vocab, _cur_epoch, _expected_examples, _expected_words, _work,
                   _neu1, compute_loss, learn_vectors=True):
                    ...
                    for j in range(j, k):
                        ...
                        if c.hs:
                            w2v_fast_sentence_sg_hs(
                                ...
                                &c.rejected_by_max_exp, c.force_log_exp, learn_vects #MODIF
                                )
                        if c.negative:
