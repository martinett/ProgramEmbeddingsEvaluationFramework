...
class KeyedVectors(utils.SaveLoad):
    ...
    def __init__(self, vector_size, count=0, dtype=np.float32, mapfile_path=None, init_normalize=True):
        ...
        mapfile_path : string, optional
            Currently unused.
        """
        self.init_normalize = init_normalize #MODIF
    ...
    def resize_vectors(self, seed=0):
        ...
        self.vectors = prep_vectors(target_shape, prior_vectors=self.vectors, seed=seed, normalize=self.init_normalize)
...
def prep_vectors(target_shape, prior_vectors=None, seed=0, normalize=True, dtype=REAL):
