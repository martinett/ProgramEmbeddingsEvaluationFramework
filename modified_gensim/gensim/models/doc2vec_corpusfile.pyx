...
from modified_gensim.gensim.models.doc2vec_inner cimport (
...
from modified_gensim.gensim.models.word2vec_inner cimport random_int32, sscal, REAL_t, our_saxpy

from modified_gensim.gensim.models.word2vec_corpusfile cimport (
    VocabItem,
    CythonVocab,
    CythonLineSentence,
    get_alpha,
...
def d2v_train_epoch_dbow(
        ...
        _expected_words, work, neu1, docvecs_count,
        compute_loss, syn1_lockf, #MODIF
        word_vectors=None, words_lockf=None,
    ...
    init_d2v_config(
        &c, model, _alpha, learn_doctags, learn_words, learn_hidden,
        compute_loss, syn1_lockf, #MODIF
