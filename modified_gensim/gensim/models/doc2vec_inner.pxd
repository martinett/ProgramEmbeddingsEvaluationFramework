...
from modified_gensim.gensim.models.word2vec_inner cimport REAL_t
...
cdef struct Doc2VecConfig:
    ...
    int compute_loss #MODIF
    REAL_t running_training_loss #MODIF
    np.uint32_t rejected_by_max_exp #MODIF
    int force_log_exp #MODIF
    int window_slide #MODIF
...
cdef init_d2v_config(Doc2VecConfig *c, model, alpha, learn_doctags, learn_words, learn_hidden,
                     ...
                     train_words=*, work=*,
                     neu1=*, word_vectors=*, words_lockf=*, doctag_vectors=*, doctags_lockf=*,
                     window_slide=*, #MODIF
                     docvecs_count=*,
                     )
