...
from modified_gensim.gensim import utils
...
try:
    ...
    from modified_gensim.gensim._matutils import logsumexp, mean_absolute_difference, dirichlet_expectation
...
try:
    from modified_gensim.gensim.corpora._mmreader import MmReader  # noqa: F401
except ImportError:
